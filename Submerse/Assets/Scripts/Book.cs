...
public class Book : MonoBehaviour {
    ...
    {
        f = Vector3.Lerp(f, transformPoint(inputManager.GetMousePosition()), Time.deltaTime * 10);
    ...
    {
        if (interactable)
        DragRightPageToPoint(transformPoint(inputManager.GetMousePosition()));
    ...
    {
        if (interactable)
        DragLeftPageToPoint(transformPoint(inputManager.GetMousePosition()));
